export const adsData = [
    ...
    { id: 4, imageUrl: '/images/cykel.png', name: 'Damcykel', price: '1200 kr', condition:'', location:'', category:'Cyklar', description: 'More information about Damcykel'  },
    { id: 5, imageUrl: '/images/apartment.png', name: '2a i Vallastaden', price: '6500 kr', condition: 'Använd - Gott skick', location: 'Linköping', category: 'Lägenhet', description: 'Hyr ut min lägenhet pga utbyte mellan maj - december. 2a på 35 kvm. Belägen i ett lugnt och välskött område.'  },
    { id: 6, imageUrl: '/images/book.png', name: 'Kursbok i TEIM32', price: '300 kr', category: 'Böcker', details: 'More information about Kursbok i TEIM32'  },
